...
impl Chromosome {
    ...
    fn determine_node_dependency(&self) -> HashMap<usize, Vec<usize>, nohash_hasher::BuildNoHashHasher<usize>> {
        // Get list with connections of each computational node.
        // Input nodes are already removed from this list
        let mut node_dependencies: HashMap<usize, Vec<usize>, nohash_hasher::BuildNoHashHasher<usize>> = HashMap::default();
    ...
    fn get_addable(&self, node_dependencies: &mut HashMap<usize, Vec<usize>, nohash_hasher::BuildNoHashHasher<usize>>, addable: &mut Vec<usize>) {
    ...
    fn update_node_index(&mut self, location_mapping: &HashMap<usize, usize, nohash_hasher::BuildNoHashHasher<usize>>) {
    ...
    fn update_node_connections(&mut self, location_mapping: &HashMap<usize, usize, nohash_hasher::BuildNoHashHasher<usize>>) {
        let total_nbr_nodes = self.params.nbr_inputs + self.params.graph_width + self.params.nbr_outputs;
    ...
    pub fn reorder(&mut self) {
        ...
        let mut changed_locations: HashMap<usize, usize, nohash_hasher::BuildNoHashHasher<usize>> = HashMap::default();
        ...
        let mut node_dependencies: HashMap<usize, Vec<usize>, nohash_hasher::BuildNoHashHasher<usize>> = self.determine_node_dependency();
